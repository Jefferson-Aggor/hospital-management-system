...
// Payment
router.route('/api/payment/:_id').get(protect, getPatientById).put(protect,checkPaid)
...
//Pharmacy
router.route('/api/user/:_id/pharmacy').get(protect, receipt).put(protect, handOverMedicine);
